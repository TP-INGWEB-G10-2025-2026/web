...
const routes = [
  ...
  // ── Admin — Materials ─────────────────────────
  { path: '/admin/materials',          page: 'pages/admin/materials/index.html',  guard: 'admin' },
  { path: '/admin/materials/create',   page: 'pages/admin/materials/create.html', guard: 'admin' },
  { path: '/admin/materials/:id/edit', page: 'pages/admin/materials/edit.html',   guard: 'admin' },
  { path: '/admin/materials/:id/loans',page: 'pages/admin/loans/history.html',    guard: 'admin' },
  { path: '/admin/materials/:id',      page: 'pages/admin/materials/show.html',   guard: 'admin' },

  // ── Admin — Categories ────────────────────────
  { path: '/admin/categories', page: 'pages/admin/categories/index.html', guard: 'admin' },

  // ── Admin — Reservations ──────────────────────
  { path: '/admin/reservations',              page: 'pages/admin/reservations/index.html',    guard: 'admin' },
  { path: '/admin/reservations/:id/validate', page: 'pages/admin/reservations/validate.html', guard: 'admin' },

  // ── Admin — Loans ─────────────────────────────
  { path: '/admin/loans',         page: 'pages/admin/loans/index.html',   guard: 'admin' },
  { path: '/admin/loans/new',     page: 'pages/admin/loans/create.html',  guard: 'admin' },
  { path: '/admin/loans/history', page: 'pages/admin/loans/history.html', guard: 'admin' },

  // ── Admin — Teachers ──────────────────────────
  { path: '/admin/teachers',              page: 'pages/admin/teachers/index.html', guard: 'admin' },
  { path: '/admin/teachers/:id/loans',    page: 'pages/admin/loans/history.html',  guard: 'admin' },
  { path: '/admin/teachers/:id',          page: 'pages/admin/teachers/show.html',  guard: 'admin' },

  // ── Admin — Statistics ────────────────────────
  { path: '/admin/statistics', page: 'pages/admin/statistics/index.html', guard: 'admin' },

  // ── Teacher ───────────────────────────────────
  { path: '/teacher/reservations',     page: 'pages/teacher/reservations/index.html',  guard: 'teacher' },
  { path: '/teacher/reservations/new', page: 'pages/teacher/reservations/create.html', guard: 'teacher' },
];
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  if (window.location.pathname === '/') {
    const dest = isAuthenticated()
      ? (isAdmin() ? '/admin/materials' : '/teacher/reservations')
      : '/login';
